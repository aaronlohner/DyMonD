...
g++ -o sniffer src/sniffer_MT_URLS.cpp src/server.cpp proto_gen/sniffed_info.pb.cc -Iinclude -lpcap -lboost_filesystem -lboost_system -pthread `pkg-config --cflags --libs protobuf`
