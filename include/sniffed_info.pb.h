...
class Flow final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_s_addr();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_s_port();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_d_addr();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_d_port();
...
inline std::string* Flow::mutable_s_addr() {
  std::string* _s = _internal_mutable_s_addr();
...
inline std::string* Flow::mutable_s_port() {
  std::string* _s = _internal_mutable_s_port();
...
inline std::string* Flow::mutable_d_addr() {
  std::string* _s = _internal_mutable_d_addr();
...
inline std::string* Flow::mutable_d_port() {
  std::string* _s = _internal_mutable_d_port();
